...
class SupplierController extends Controller
{
    ...
    {
        return view('dashboard.allSupplier',[
            'allSupplier' => Supplier::where('users_id',session('user')[0]->id)->paginate(5)
        ]);
    }
    ...
    {
        return view('dashboard.addSupplier');
    }
    ...
    public function store(Request $request)
    {
        $validated = $request->validate([
            ...
            'email' => 'required|email|min:5|max:30|unique:suppliers',
        ]);
