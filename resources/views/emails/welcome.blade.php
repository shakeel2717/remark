                                        ...
                                        <tbody>
                                            <tr>
                                                <td style="word-break:break-word;font-size:0px;padding:0px 0px 20px;"
                                                    align="left">
                                                    <div
                                                        style="cursor:auto;color:#737F8D;font-family:Whitney, Helvetica Neue, Helvetica, Arial, Lucida Grande, sans-serif;font-size:16px;line-height:24px;">
                                                        <p style="text-align:center; margin-bottom:30px;"><img
                                                                src="{{ asset('assets/svg/components/check-soft-bg.svg') }}"
                                                                alt="Party Wumpus" title="None" width="150"
                                                                style="height: auto;"></p>
                                                        ...
                                                        <h2
                                                            ...
                                                            Hey {{ session('notice')['username'] }},</h2>
                                                        <p>Wowwee! Thanks for registering an account with
                                                            {{ env('APP_NAME') }}!</p>
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td style="border:none;border-radius:3px;color:white;cursor:auto;padding:15px 19px;"
                                                                    align="center" valign="middle" bgcolor="#377dff"><a
                                                                        href="{{ env('APP_URL') }}verify/{{ $token }}"
                                                                        style="text-decoration:none;line-height:100%;background:#377dff;color:white;font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:15px;font-weight:normal;text-transform:none;margin:0px;"
                                                                        target="_blank">
                                                                        Verify Email
                                                                    </a></td>
                                                            </tr>
